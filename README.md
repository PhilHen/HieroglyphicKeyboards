...
# Installation
* If there is a .kmp file matching your physical keyboard in the [keyboards] (keyboards) folder, download this file and use keyman to install it on your system (keyman should be the default handler for .kmp file)
